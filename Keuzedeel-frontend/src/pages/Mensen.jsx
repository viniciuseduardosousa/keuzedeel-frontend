  ...
  return (
    <div className="container mx-auto px-4 py-24">
      ...
      <div>
        ...
        de Wibautgroep kunt u contact opnemen met onze afdeling <Link className="underline text-black hover:text-blue-800" href="mailto:mg_markt_en_capaciteit.pmb@amsterdam.nl">Markt en Capaciteit.</Link></p>
      </div>
    </div>
  );
};
